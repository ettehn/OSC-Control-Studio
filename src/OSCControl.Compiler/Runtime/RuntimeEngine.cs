...
public sealed class RuntimeEngine : IAsyncDisposable
{
    ...
    private readonly Dictionary<string, RuntimeFunctionPlan> _functions;
    ...
    public RuntimeEngine(RuntimePlan plan, RuntimeEngineOptions? options = null)
    {
        ...
        _functions = plan.Functions.ToDictionary(function => function.Name, StringComparer.Ordinal);
        ...
        _stepExecutor = new RuntimeStepExecutor(_evaluator, transportScheduler, LogSink, CommandInvoker, _functions);
    ...
    public IReadOnlyDictionary<string, RuntimeFunctionPlan> Functions => _functions;
